...
export function mapLoan(l: DbLoan): Loan {
  return {
    ...
    isImported: l.is_imported === true,
    openingDate: l.opening_date,
    originalBookStartDate: l.original_book_start_date,
    openingBalanceAtImport: l.opening_balance_at_import,
    openingPaidBeforeSystem: l.opening_paid_before_system,
    openingArrearsAtImport: l.opening_arrears_at_import,
    openingLateFeeAtImport: l.opening_late_fee_at_import,
    importedNotes: l.imported_notes,
    completedInstallmentsAtImport: l.completed_installments_at_import,
