...
export const t = {
  ...
  ledgerColDebit: bi('Charge', 'ගාස්තු'),
  ledgerColCredit: bi('Paid', 'ගෙවූ'),
  ledgerColBalance: bi('Current Due Balance', 'දැනට ගෙවිය යුතු ශේෂය'),
  ledgerColLoanTotalBalance: bi('Total Loan Balance', 'මුළු ණය ශේෂය'),
  ledgerDescLoanReleased: bi('Loan released', 'ණය නිකුත් කිරීම'),
  ...
  guaranteeInformation: bi('Guarantee Information', 'ඇපකර තොරතුරු'),
  fileNumber: bi('File Number', 'ගොනු අංකය'),
  vehicleNumber: bi('Vehicle Number', 'වාහන අංකය'),
  guarantor1: bi('Guarantor 1', 'ඇපකරු 1'),
  guarantor2: bi('Guarantor 2', 'ඇපකරු 2'),
  guarantorName: bi('Name', 'නම'),
  guarantorAddress: bi('Address', 'ලිපිනය'),
  guarantorPhone: bi('Phone', 'දුරකථන'),
  guarantorNic: bi('NIC', 'හැඳුනුම්පත්'),
  guaranteeStatusHeld: bi('Held', 'භාරයේ ඇත'),
  guaranteeStatusReleased: bi('Released', 'නිදහස් කර ඇත'),
  guaranteeReleasedDate: bi('Released', 'නිදහස් කළ දිනය'),
  guaranteeOptionalHint: bi(
    'All fields are optional. Leave blank if the customer did not provide details.',
    'සියලු ක්ෂේත්‍ර අනිවාර්ය නොවේ. ගනුදෙනුකරු විස්තර නොදුන්නේ නම් හිස් තබන්න.'
  ),
  ...
  docSearchPlaceholder: bi(
    'Search by document no., customer, NIC, or loan no.',
    'ලේඛන අංකය, පාරිභෝගික, ජා.හැ. හෝ ණය අංකය'
  ),
  docFilterAll: bi('All', 'සියල්ල'),
  docFilterLoanInvoices: bi('Loan Invoices', 'ණය බිල්'),
  docFilterPaymentReceipts: bi('Payment Receipts', 'ගෙවීම් ලදුපත්'),
  docFilterCashSales: bi('Cash Sales', 'මුදල් විකිණුම්'),
  docDateFrom: bi('From', 'සිට'),
  docDateTo: bi('To', 'දක්වා'),
  docSortOrder: bi('Sort order', 'අනුපිළිවෙල'),
  docSortNewest: bi('Newest first', 'නවතම පළමුව'),
  docSortOldest: bi('Oldest first', 'පැරණිතම පළමුව'),
  docColNumber: bi('Document No.', 'ලේඛන අංකය'),
  docColType: bi('Type', 'වර්ගය'),
  docColLoanNumber: bi('Loan No.', 'ණය අංකය'),
  docColCreated: bi('Created', 'සාදන ලදී'),
  docColTotal: bi('Total', 'මුළු මුදල'),
  docColPrintCount: bi('Prints', 'මුද්‍රණ'),
  docColStatus: bi('Status', 'තත්වය'),
  docColCreatedBy: bi('Created By', 'සාදන ලද්දේ'),
  docStatusOriginal: bi('Original', 'මුල් පිටපත'),
  docStatusReprinted: bi('Reprinted', 'නැවත මුද්‍රණය'),
  docActionPrint: bi('Print', 'මුද්‍රණය'),
  docActionReprint: bi('Reprint', 'නැවත මුද්‍රණය'),
  docNoDocumentsFound: bi('No documents found', 'ලේඛන හමු නොවීය'),
  docRegistryCount: bi('Documents', 'ලේඛන'),
  docPageIndicator: bi('Page', 'පිටුව'),
  docPaginationPrev: bi('Previous', 'පෙර'),
  docPaginationNext: bi('Next', 'ඊළඟ'),
  docTypeLoanInvoice: bi('Loan Invoice', 'ණය බිල'),
  docTypePaymentReceipt: bi('Payment Receipt', 'ගෙවීම් ලදුපත'),
